...
const Signup = () => {
  ...
  return (
    <div className='p-3 md:p-4'>
        <div className=' abc w-full max-w-sm bg-white m-auto flex items-center flex-col p-4 relative' bg-blue>
           ...
           <p className='text-sm'>Already have a account ? <Link to={'/loginS'} className='text-blue-400 underline'>Login</Link></p>
        </div>
    </div>
  );
}
